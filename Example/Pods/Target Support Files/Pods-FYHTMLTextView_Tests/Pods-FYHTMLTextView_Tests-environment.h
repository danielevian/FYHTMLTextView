...
// FYHTMLTextView
#define COCOAPODS_POD_AVAILABLE_FYHTMLTextView
#define COCOAPODS_VERSION_MAJOR_FYHTMLTextView 1
#define COCOAPODS_VERSION_MINOR_FYHTMLTextView 0
#define COCOAPODS_VERSION_PATCH_FYHTMLTextView 9
